...
= 3.1.86 - 2024-18-04 =
* Enhancement - Support both classic and block based checkout with the pickup point map
* fix - Pickup point map refactor

= 3.1.85 - 2024-10-04 =
* fix - Pickup point map showing up on non checkout pages
* Enhancement - Label print functionality update to be part of /shipments request
* fix - Added forgotten carrier pickup point pins

= 3.1.84 - 2024-21-03 =
* fix - Map select box positioning update

= 3.1.83 - 2024-04-03 =
* fix - Frontend recompilation
* fix - Version update
