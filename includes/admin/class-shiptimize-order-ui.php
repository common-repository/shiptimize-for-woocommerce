...
//    $response = new WP_REST_Response($labelResponse, 200);
    ...
    public function register_bulk_export($bulk_actions) {
        ...
        $bulk_actions['shiptimize_export'] = $shiptimize->translate( 'Export to' ) . ' ' . SHIPTIMIZE_BRAND;
        $bulk_actions['shiptimize_printlabel'] =  SHIPTIMIZE_BRAND .': ' . $shiptimize->translate('printlabel');
