<?php
return array(
    'shiptimizecolumntitle' => 'Status / Handling',
    'automaticexport' => 'Automatisk Eksport',
    'automaticexportdescription' => 'Send ordrer til Shiptimize når status matcher',
    ...
    'labeltermsintro' => "<p>Du kan udskrive labels manuelt eller automatisk ved at eksportere dem til Shiptimize, men du kan også udskrive labels direkte fra Woocommerce.</p><p>Hvis du ønsker at udskrive labels direkte fra Woocommerce, skal du kontrollere, at du har læst disse vilkår under \"udskriv label\" i fanen \"indstillinger\".</p><p>For at udskrive en label fra ordrelisten skal du klikke på \"udskriv label\"-knappen.</p>",
    'labelterms' => "Så snart du klikker på 'udskriv etiket'-knappen, sker følgende:
    <ol class=\"shiptimize-list\">
    <li>Ordren eksporteres til Shiptimize, og ordredetaljerne sendes til transportøren, så hvis indsendelsen er vellykket, kan vi sende en forsendelsesmærkat tilbage til shoppingplatformen.</li>
    <li>Du kan angive labelformatet i Shiptimize-appen \"Indstillinger\" > \"Udskrivning\" > \"Udskriv etiketformat\"</li>
    ...
    <li>Hvis din <i>kunde vælger en af ​​Shiptimize-transportørerne ved kassen</i>, vil transportøren og de muligheder, du har angivet for den i woocommerce, <i>givet at de er gyldige for forsendelsen</i>, blive tildelt forsendelsen</li>
    <li>Hvis der ikke er tilknyttet nogen Shiptimize-transportør til ordren, <i>vælges transportøren og indstillingerne i Shiptimize forsendelsesportalen under \"Indstillinger\" > \"Standardindstillinger\" > \"Standardtransportør\" automatisk.</i></li>
    ...
    <li><b>Hvis du laver en fejl, kan du kontakte Shiptimize gennem supportafsnittet på hjemmesiden, og vi vil hjælpe dig. Tid er afgørende, bekræft venligst, om label er korrekt, efter at du har modtaget den.</b></li>
    </ol>",
    ...
    'labellocked' => 'Udskrivning af label deaktiveret. Gå til Shiptimize-indstillingerne og kontroller, om du forstår, hvordan udskrivning af label fungerer',
    ...
    <li>Vælg Shiptimize: udskriv label, fra handlingsrullelisten</li>
...
//  WOO SPECIFIC STUFF
    ...
    'setcredentials' =>  'ugyldige nøgler! Bekræft i Shiptimize-indstillingerne, om du har kopieret dem korrekt',
...
<br/>Kontakt venligst din webudvikler for at aktivere din WordPress API, og gå tilbage til denne skærm for at finde instruktioner. %s</p>
    ",
    'useapihelp' => 'Når du har konfigureret ordrestatusser til automatisk at blive opdateret ved visse begivenheder (ved import, labeloprettelse og/eller levering), men du ser "ikke fundet" resultater i sporingsopdateringerne for forsendelser i din Shiptimize-konto, skal du tage følgende skridt:
<ol>
    <li>Aktivér "Brug WordPress API til ordreopdateringer" nedenfor. %s </li>
    <li>Gå til din Shiptimize-konto for at oprette nye nøgler fra "Indstillinger" > "Integrationer" > "N
    <li>Gå til din Shiptimize-konto for at oprette nye nøgler fra "Indstillinger" > "Integrationer" > "Nøglehåndtering" og aktiver nøglerne.</li>
    <li>Indsæt disse nye nøgler i Shiptimize Legitimationsfeltet i Shiptimize-indstillingerne her i WordPress, og klik på "Gem ændringer"-knappen.</li>
</ol>',
//  Sub values..
    'extraoptions55' => '&nbsp;&nbsp;&nbsp;&nbsp;>',
    'extraoptions73' => '&nbsp;&nbsp;&nbsp;&nbsp;>',
//  Marketplace
    'sending' => 'Sender ...',
    'requestaccount' => 'Anmod om Shiptimize-konto for denne leverandør',
    ...
    'connect2shiptimize' => 'Forbind til Shiptimize',
    'disconnectshiptimize' => 'Frakobl fra Shiptimize',
    'welcometitle' => 'Velkommen til Shiptimize & PakketMail',
...
Forbedring af din kundeservice',
    ...
    'shiptimizesettings' => 'Shiptimize Indstillinger',
    'whopays' => 'Hvem betaler Shiptimize?',
    'you' => 'Du',
    'yourvendors' => 'Dine Leverandører',
    'whopaysdescription' => 'Hvis du betaler Shiptimize, vil enhver leverandør, der sender med Shiptimize, arve de takster, du definerer',
